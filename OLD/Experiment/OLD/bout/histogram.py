...
ax[0].bar(x= list(np.arange(0.5,20.5-1)), height = p_step, width = .8, bottom = 0, color = color[0])
ax[1].bar(x= list(np.arange(0.5,20.5-1)), height = w_step, width = .8, bottom = 0, color = color[1])
ax[0].set_xticks(np.arange(0,20))
ax[0].set_xticklabels(np.arange(0,(20)*50,50), fontsize =7)
ax[1].set_xticks(np.arange(0,20))
ax[1].set_xticklabels(np.arange(0,(20)*50,50), fontsize =7)
...
# ax[2][0].set_xticks(np.arange(0,20))
# ax[2][0].set_xticklabels(np.arange(0,200,10),fontsize = 7)
# ax[2][1].set_xticks(np.arange(0,20))
# ax[2][1].set_xticklabels(np.arange(0,200,10),fontsize = 7)
...
# fig.supxlabel('''distribution of bouts''', fontsize = 16)
