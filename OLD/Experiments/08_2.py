...
for idx, btype in enumerate(["phone","watch"]):
    ...
    ax[idx].set_xlabel(f"{btype} Covering Ratio for Day")
    ax[idx].set_ylabel(f"{btype} Covering Ratio for Night")
fig.supxlabel("Scatter Plot between Day/Night Covering Ratio")
