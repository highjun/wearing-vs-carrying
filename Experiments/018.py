...
tmp = tmp_hour.groupby("hour").agg(phone=("p_step","sum"), watch = ("w_step","sum"), bp = ("bp_step","sum"), bw = ("bw_step","sum"))
tmp["b_step"] = [(tmp["bp"]+tmp["bw"])/2 for idx, row in tmp.iterrows()]
